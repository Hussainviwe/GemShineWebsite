    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/gem2.jpg')"
          }}
        ></div>
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-lg md:text-xl mb-12 animate-slide-up opacity-80 max-w-2xl mx-auto">
            Discover the world's finest gemstones, expertly curated and
            ethically sourced for discerning collectors
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Over 25 years of expertise in bringing you the world's most
              exquisite gemstones
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Every gemstone comes with professional certification and
                detailed documentation, ensuring authenticity and quality you
                can trust.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our master gemologists hand-select each stone for exceptional
                clarity, color, and brilliance that exceeds industry standards.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Complimentary insured shipping, 30-day returns, and lifetime
                authenticity guarantee with personalized customer service.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-navy-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Be the first to discover new arrivals, exclusive offers, and expert
            insights from the world of fine gemstones.
          </p>
